...
#define MOTOR_C_IN1_PORT GPIOB
#define MOTOR_C_IN1_PIN GPIO_Pin_14

#define MOTOR_C_IN2_PORT GPIOA
...
#define MOTOR_D_IN1_PORT GPIOA
#define MOTOR_D_IN1_PIN GPIO_Pin_8

#define MOTOR_D_IN2_PORT GPIOA
#define MOTOR_D_IN2_PIN GPIO_Pin_12

#define MOTOR_D_PWM_PORT GPIOB
#define MOTOR_D_PWM_PIN GPIO_Pin_1


#define MOTOR_A_STBY_PORT GPIOB
#define MOTOR_A_STBY_PIN GPIO_Pin_10

#define MOTOR_B_STBY_PORT GPIOA
#define MOTOR_B_STBY_PIN GPIO_Pin_4

#define MOTOR_ENCODER_PORT GPIOB
#define MOTOR_ENCODER_A_PIN GPIO_Pin_5

#define MOTOR_ENCODER_B_PIN GPIO_Pin_6

#define MOTOR_ENCODER_C_PIN GPIO_Pin_7

#define MOTOR_ENCODER_D_PIN GPIO_Pin_8


#define MOTOR_ENCODER_PORTSOURCE GPIO_PortSourceGPIOB

#define MOTOR_ENCODER_A_PINSOURCE GPIO_PinSource5

#define MOTOR_ENCODER_B_PINSOURCE GPIO_PinSource6

#define MOTOR_ENCODER_C_PINSOURCE GPIO_PinSource7

#define MOTOR_ENCODER_D_PINSOURCE GPIO_PinSource8
